...
export default function AddAssetDialog({ open, onOpenChange, onAddAsset, assetType }: AddAssetDialogProps) {
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            {assetType === "stock" && (
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-black font-bold">Stock Name</FormLabel>
                    <FormControl>
                      <Input
                        {...field}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-black font-bold">Quantity</FormLabel>
                  <FormControl>
                    <Input
                      {...field}
                      type="number"
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-black font-bold">Purchase Price (₹)</FormLabel>
                  <FormControl>
                    <Input
                      {...field}
                      type="number"
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-black font-bold">Purchase Date</FormLabel>
                  <FormControl>
                    <Input
                      {...field}
                      type="date"
